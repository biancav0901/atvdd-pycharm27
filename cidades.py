...
class Application:
    def _init_(self, master=None):
         ...
         self.titulo.pack ()
         self.lblidcidades = Label(self.container2,
         text="idCidade:", font=self.fonte, width=10)
         self.lblidcidades.pack(side=LEFT)
         self.txtidcidades = Entry(self.container2)
         self.txtidcidades["width"] = 10
         self.txtidcidades["font"] = self.fonte
         self.txtidcidades.pack(side=LEFT)
         ...
         self.lblcidade= Label(self.container6, text="Usuário:",
         font=self.fonte, width=10)
         ...
         font=self.fonte, width=12)
         self.bntExcluir["command"] = self.excluirCidades
    ...
    def buscarCidade(self):
         ...
         self.lblmsg["text"] = user.selectUser(idcidade)
         self.txtidcidade.delete(0, END)
